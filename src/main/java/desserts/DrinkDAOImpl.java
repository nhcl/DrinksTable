...
public class DrinkDAOImpl implements DrinkDAO{
    ...
    final static String SELECT_ID_SPECIFIED_SQL = "SELECT id, name, good FROM drinks WHERE id = ?;";
	...
	@Override
	public List<DrinkDTO> getSpecific(Long id) {
		
		List<DrinkDTO> drinks = new ArrayList<>();
		
		try (PreparedStatement preparedStatement = conn.prepareStatement(SELECT_ID_SPECIFIED_SQL)) {
